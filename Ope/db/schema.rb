...
ActiveRecord::Schema.define(version: 2019_09_19_131103) do
  ...
  create_table "fornecedor_items", force: :cascade do |t|
    t.bigint "fornecedor_id", null: false
    t.bigint "produto_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["fornecedor_id"], name: "index_fornecedor_items_on_fornecedor_id"
    t.index ["produto_id"], name: "index_fornecedor_items_on_produto_id"
  end
  ...
  add_foreign_key "fornecedor_items", "fornecedors"
  add_foreign_key "fornecedor_items", "produtos"
